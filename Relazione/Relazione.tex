...
Oltre a creare un nuovo materiale ed utilizzarlo come chiave per la colonnina, si controlla che il codice inserito in Bicicletta sia veramente una bicicletta.%credo non serva controllare bicicletta, in teoria lo fa già la chiave esterna
\begin{lstlisting}[
           language=SQL,
           showspaces=false,
           basicstyle=\ttfamily,
