...
\begin{itemize}
 ...
 \item per la manutenzione si utilizza la data e si aggiunge un numero di manutententione giornaliero
\end{itemize}
\begin{figure}[H]
 \centering
...
\end{figure}
Si decide di raffinare subito la relazione, creando l'entita Abbonamento per scomporre la relazione N:N.
\begin{figure}[H]
 \centering
...
%da ricontrollare sopra se ci sono tutte
