...
\begin{figure}[H]
 \centering
 \includegraphics[width=10\textwidth]{Concettuale01}
...
\begin{figure}[H]
 \centering
  \includegraphics[width=1\textwidth]{Concettuale02}
...
\begin{figure}[H]
 \centering
  \includegraphics[width=1\textwidth]{Concettuale06}
...
\begin{figure}[H]
 \centering
  \includegraphics[width=1\textwidth]{Concettuale11}
...
\begin{figure}[H]
 \centering
  \includegraphics[width=1\textwidth]{Concettuale12}
...
\begin{figure}[H]
 \centering
  \includegraphics[width=1\textwidth]{ConcettualeFinale}
...
\begin{figure}[H]
 \centering
  \includegraphics[width=1\textwidth]{LogicoFinale}
...
WHERE Operazione.IdTessera = OLD.IdTessera ORDER BY Operazione.Orario
DESC LIMIT 1;
